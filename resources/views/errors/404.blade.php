...
<body class="antialiased min-h-screen flex items-center justify-center relative">
    ...
    <!-- Orbs -->
    <div class="orb w-[500px] h-[500px] bg-blue-600/20 top-[-100px] left-[-150px] animate-pulse-glow"></div>
    <div class="orb w-[400px] h-[400px] bg-violet-700/20 bottom-[-50px] right-[-100px] animate-pulse-glow" style="animation-delay: 1s"></div>

    <div class="relative z-10 text-center px-6 max-w-2xl mx-auto flex flex-col items-center">
        <!-- Error Code -->
        <h1 class="text-9xl font-black mb-4 gradient-text animate-float" style="letter-spacing: -0.05em; line-height: 1;">404</h1>
        
        <!-- Error Title -->
        <h2 class="text-3xl md:text-4xl font-bold mb-4 text-white">Oops! Halaman Tidak Ditemukan</h2>
        
        <!-- Error Message -->
        <p class="text-gray-400 text-lg mb-10">Kami tidak dapat menemukan apa yang Anda cari. Halaman ini mungkin telah dipindahkan atau tidak pernah ada.</p>
