...
<aside :class="sidebarOpen ? 'w-64' : 'w-0 overflow-hidden border-r-0'"
    ...
    <div class="px-5 py-5 border-b border-[#21262d] shrink-0">
        <a href="{{ Auth::user()->role === 'admin' ? route('admin.dashboard') : route('dashboard') }}"
            ...
            <img src="{{ asset('assets/icon/burung-utama.png') }}" alt="Dijadiin"
                class="w-20 h-20 object-contain shrink-0 -my-3" />
            <div x-show="sidebarOpen" x-transition:enter="transition-opacity duration-200 delay-100"
                ...
                x-transition:leave-end="opacity-0" class="whitespace-nowrap -ml-1">
                <p class="font-bold text-base text-white leading-tight">DIJADIIN</p>
    ...
    <div class="border-t border-[#21262d] p-3 shrink-0">
        <div class="flex items-center gap-2.5">
            ...
            <button x-show="sidebarOpen" type="button" @click="showLogoutModal = true" title="Log Out"
                ...
                class="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors shrink-0 cursor-pointer">
...
<div class="sm:hidden flex items-center justify-between p-4 bg-[#0d1117] border-b border-[#21262d] shrink-0">
    <a href="{{ Auth::user()->role === 'admin' ? route('admin.dashboard') : route('dashboard') }}"
        class="flex items-center gap-0 group">
        <img src="{{ asset('assets/icon/burung-utama.png') }}" alt="Dijadiin" class="w-16 h-16 object-contain -my-2" />
        <span class="font-bold text-base text-white ml-1">DIJADIIN</span>
    </a>
            ...
            <div class="px-3 py-3 space-y-1">
                ...
                <div class="mt-3 pt-3 border-t border-[#21262d]">
                    ...
                    <button type="button" @click="showLogoutModal = true; open = false"
                        class="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-red-400 hover:bg-red-500/10 transition-colors cursor-pointer">
                        Log Out
                    </button>
                </div>
            </div>
