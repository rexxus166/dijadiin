...
<body class="antialiased">
    ...
    <footer class="border-t border-white/5 py-10 px-6">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-2">
                <div class="w-6 h-6 rounded-md bg-gradient-to-br from-blue-500 to-violet-600 flex items-center justify-center">
                    <span class="text-white text-xs font-black">D</span>
                </div>
                <span class="font-bold text-sm text-white">DIJADIIN</span>
            </div>

            <div class="flex items-center flex-wrap justify-center gap-6 text-sm text-gray-500">
                ...
                <a href="#perbandingan" class="hover:text-white transition-colors">Perbandingan</a>
                @if (Route::has('login'))
