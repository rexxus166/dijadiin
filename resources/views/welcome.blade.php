...
<head>
    ...
    <meta name="description"
        content="Bangun aplikasi Laravel 12 yang siap pakai hanya dengan menceritakan ide Anda. Tanpa ribet, langsung jadi kode.">
...
<body class="antialiased">
        ...
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center gap-0 group">
                <img src="{{ asset('assets/icon/burung-utama.png') }}" alt="DIJADIIN"
                    class="w-20 h-20 object-contain group-hover:scale-110 transition-transform -my-3" />
                <span class="font-bold text-lg text-white tracking-tight ml-1">DIJADIIN</span>
            </a>
            ...
            <div class="hidden md:flex items-center gap-8 text-sm text-gray-400">
                <a href="#fitur" class="hover:text-white transition-colors duration-200 relative group">
                    Fitur
                    <span
                        class="absolute -bottom-1 left-0 w-0 h-px bg-blue-400 group-hover:w-full transition-all duration-300"></span>
                </a>
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ route('dashboard') }}"
                            class="text-sm text-gray-400 hover:text-white transition-colors px-4 py-2">
                            Dashboard
                        </a>
                    @else
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden dot-grid pt-20">
        ...
        <div class="orb absolute w-[600px] h-[600px] bg-blue-600/20 top-[-100px] left-[-150px] animate-pulse-glow">
        </div>
        <div class="orb absolute w-[500px] h-[500px] bg-violet-700/20 bottom-[-100px] right-[-150px] animate-pulse-glow"
            style="animation-delay:1.5s"></div>
        <div class="orb absolute w-[300px] h-[300px] bg-indigo-500/10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse-glow"
            style="animation-delay:0.8s"></div>

        <div class="relative z-10 max-w-4xl mx-auto px-6 text-center">

            <!-- Badge -->
            <div class="inline-flex items-center gap-2 badge-shimmer rounded-full px-4 py-2 mb-8 opacity-0 animate-fade-in"
                style="animation-delay:0.2s;animation-fill-mode:forwards">
                <div class="w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce-soft"></div>
                <span class="text-blue-300 text-xs font-semibold tracking-widest uppercase">✦ Pembuat Aplikasi dengan
                    AI</span>
            </div>

            <!-- Headline -->
            <h1 class="text-5xl md:text-7xl font-black leading-[1.05] mb-6 tracking-tight opacity-0 animate-slide-up"
            ...
            <!-- Subheadline -->
            <p class="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed opacity-0 animate-slide-up"
                style="animation-delay:0.5s;animation-fill-mode:forwards">
                Buat aplikasi teranyar dan modern dengan sangat cepat, cukup ceritakan ide Anda disini.
                Tanpa harus dibuat pusing dari 0, barisan koding langsung tersedia untukmu!
            </p>

            <!-- CTA Buttons -->
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-slide-up"
            ...
            <div class="relative h-16 mt-16 hidden md:block opacity-0 animate-fade-in"
                ...
                <div class="float-badge animate-float left-[5%] md:left-[8%]" style="top:-10px">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-gray-300 font-medium">Siap Pakai Laravel 12</span>
                    </div>
                </div>
                <div class="float-badge animate-float-delay" style="top:-10px;right:5%;right:8%">
                    <div class="flex items-center gap-2">
                        <span class="text-blue-400">⚡</span>
                        <span class="text-gray-300 font-medium">Dibuat sangat cepat</span>
                    </div>
                </div>
            </div>
        ...
        <!-- Scroll indicator -->
        <div
            class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60 animate-bounce-soft">
            <span class="text-xs text-gray-500 tracking-widest uppercase">Lihat Bawah</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="feature-card rounded-2xl p-7 reveal reveal-delay-1">
                    <div
                        class="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-5">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Deskripsikan aplikasimu dan dapatkan kode Laravel 12 yang siap pakai dalam hitungan detik. Tanpa
                        delay, langsung bisa dijalankan.
                    </p>
                </div>
                ...
                <div class="feature-card rounded-2xl p-7 reveal reveal-delay-2">
                    <div
                        class="w-12 h-12 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center mb-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                    ...
                    <h3 class="text-white font-bold text-lg mb-2">Penuh Hak Milik Kode</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Seluruh file hasil kodingan adalah hakmu sepenuhnya. Tanpa campur tangan biaya sewa sistem,
                        letakkan aplikasi dimanapun senyamannya dirimu.
                    </p>
                </div>
                ...
                <div class="feature-card rounded-2xl p-7 reveal reveal-delay-3">
                    <div
                        class="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                            stroke="#34d399" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                        </svg>
                    </div>
                    <h3 class="text-white font-bold text-lg mb-2">Mengikuti Standar Terbaru</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">
                        Kami buatkan aplikasi dengan versi pemograman terkini (Laravel), struktur file rapi, dan mudah
                        dibaca oleh programmer lain di masa depan.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="cara-kerja" class="py-24 px-6 bg-[#050505] relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 relative">
                ...
                <!-- Desktop connectors -->
                <div
                    class="hidden md:block absolute top-9 left-[calc(33.333%+20px)] w-[calc(33.333%-40px)] h-px bg-gradient-to-r from-blue-500/40 to-violet-500/40">
                </div>
                <div
                    class="hidden md:block absolute top-9 left-[calc(66.666%+20px)] w-[calc(33.333%-40px)] h-px bg-gradient-to-r from-violet-500/40 to-emerald-500/40">
                </div>
                ...
                <div class="flex flex-col items-center text-center reveal reveal-delay-1">
                    <div class="relative mb-6">
                        <div
                            class="w-[72px] h-[72px] rounded-2xl bg-[#0f1623] border border-blue-500/30 flex items-center justify-center shadow-xl shadow-blue-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                                fill="none" stroke="#60a5fa" stroke-width="1.8" stroke-linecap="round"
                        ...
                        <div
                            class="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white text-xs font-bold flex items-center justify-center shadow-lg shadow-blue-500/40">
                            1</div>
                    </div>
                    <h3 class="text-white font-semibold text-lg mb-2">Tulis Ide</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">Jelaskan aplikasi yang ingin Anda buat dengan
                        bahasa natural yang detail dan jelas.</p>
                </div>
                ...
                <div class="flex flex-col items-center text-center reveal reveal-delay-2">
                    <div class="relative mb-6">
                        <div
                            class="w-[72px] h-[72px] rounded-2xl bg-[#130f1e] border border-violet-500/30 flex items-center justify-center shadow-xl shadow-violet-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                        ...
                        <div
                            class="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full bg-gradient-to-br from-violet-500 to-violet-600 text-white text-xs font-bold flex items-center justify-center shadow-lg shadow-violet-500/40">
                            2</div>
                    </div>
                    <h3 class="text-white font-semibold text-lg mb-2">AI Proses</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">AI kami menganalisis kebutuhan dan membangun
                        struktur serta kode untuk Anda secara otomatis.</p>
                </div>
                ...
                <div class="flex flex-col items-center text-center reveal reveal-delay-3">
                    <div class="relative mb-6">
                        <div
                            class="w-[72px] h-[72px] rounded-2xl bg-[#0d1a12] border border-emerald-500/30 flex items-center justify-center shadow-xl shadow-emerald-500/10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                                fill="none" stroke="#34d399" stroke-width="1.8" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <div
                            class="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 text-white text-xs font-bold flex items-center justify-center shadow-lg shadow-emerald-500/40">
                            3</div>
                    </div>
                    <h3 class="text-white font-semibold text-lg mb-2">Dapatkan File-nya</h3>
                    <p class="text-gray-400 text-sm leading-relaxed">Unduh semua kodenya (dalam bentuk ZIP). Selanjutnya
                        di-ekstrak saja dan bisa di-online-kan seketika!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="perbandingan" class="py-24 px-6 relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-14 reveal">
                <p class="text-blue-400 text-xs font-bold tracking-[0.2em] uppercase mb-3">DIJADIIN vs No-Code (Tanpa
                    Ngoding)</p>
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-3">Keunggulan Aplikasi Kami</h2>
                <p class="text-gray-400">Inilah pembeda kami jika disandingkan dengan saingan pembuat web visual.</p>
            </div>
            ...
            <div class="reveal rounded-2xl overflow-hidden" style="border:1px solid rgba(255,255,255,0.07)">
                ...
                <div class="grid grid-cols-3 bg-[#111111] border-b border-white/7">
                    <div class="p-5 text-xs text-gray-500 font-bold uppercase tracking-widest">Fitur Unggulan</div>
                    <div class="p-5 text-center border-x border-white/7">
                        <span class="gradient-text font-bold text-sm">DIJADIIN</span>
                    </div>
                    <div class="p-5 text-center text-xs text-gray-500 font-bold uppercase tracking-widest">Website
                        Kompetitor Lain</div>
                </div>
                ...
                @php
                    $rows = [
                        ['Script Kode Milik Siapa?', '✓ 100% Punya Kamu', '✗ Tidak Bisa Diambil'],
                        ['Sistem yang Dipakai', '✓ Modern & Awam Tau', '✓ Terbatas & Kuno'],
                        ['Nilai Harga Jual Kode', '✓ Sangat Bernilai', '✗ Gak Mempan Dijual'],
                        ['Bisakah Diedit Programmer Lanjutan?', '✓ Gampang Banget!', '✗ Hampir Mustahil'],
                        ['Kebebasan Menyewa Server', '✓ Pilih Hosting Sebisa Kamu', '✗ Harus Beli Sama Mereka'],
                    ];
                @endphp
                @foreach($rows as $i => $row)
                    <div
                        class="cmp-row grid grid-cols-3 border-b border-white/5 last:border-0 transition-colors duration-200 {{ $i % 2 === 1 ? 'bg-white/[0.015]' : '' }}">
                        <div class="p-5 text-sm text-gray-300">{{ $row[0] }}</div>
                        <div class="p-5 text-center border-x border-white/5">
                            <span
                                class="text-sm {{ str_starts_with($row[1], '✓') ? 'text-emerald-400' : 'text-gray-600' }} font-medium">{{ $row[1] }}</span>
                        </div>
                        <div class="p-5 text-center">
                            <span
                                class="text-sm {{ str_starts_with($row[2], '✓') ? 'text-gray-400' : 'text-red-400' }} font-medium">{{ $row[2] }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="cta-bg relative rounded-3xl p-14 text-center overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="inline-flex items-center gap-2 badge-shimmer rounded-full px-4 py-2 mb-6">
                        ...
                        <span class="text-indigo-300 text-xs font-semibold tracking-widest uppercase">Daftar Gratis
                            Sekarang</span>
                    </div>
        ...
        <div class="max-w-6xl mx-auto px-6 py-12">
            ...
            <div class="flex flex-col md:flex-row items-start justify-between gap-10 mb-10">
                ...
                <div class="flex flex-col gap-4 max-w-xs">
                    <a href="/" class="flex items-center gap-0 group">
                        <img src="{{ asset('assets/icon/burung-utama.png') }}" alt="DIJADIIN"
                            class="h-20 w-20 object-contain group-hover:scale-110 transition-transform -my-3">
                        <span class="font-bold text-lg text-white tracking-tight ml-1">DIJADIIN</span>
                    </a>
                    <p class="text-gray-500 text-sm leading-relaxed">
                        Ciptakan aplikasi dari pemikiran cerdasmu menjadi kode sistem yang hidup — gampang bikinnya,
                        lebih asik menjalankannya tanpa repot.
                    </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-10">
                    ...
                    <div>
                        ...
                        <ul class="flex flex-col gap-3 text-sm text-gray-500">
                            ...
                            @endif
                            @if (Route::has('register'))
                                <li><a href="{{ route('register') }}" class="hover:text-white transition-colors">Daftar
                                        Gratis</a></li>
                            @endif
                        </ul>
                    </div>
            ...
            <div class="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span class="text-sm text-gray-600">© {{ date('Y') }} DIJADIIN. Hak Cipta Dilindungi.</span>
    ...
    <script>
        ...
        const words = ['Mewujudkan Aplikasimu', 'Sistem Paling Handal', 'Super Cepat', 'Kodingan Anti Ribet'];
